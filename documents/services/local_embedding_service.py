...
class LocalEmbeddingService:
    ...
    def __init__(self, embedding_model_version: Optional[str] = None):
        ...
        self.vector_dim = self.model_dimensions.get(
            self.embedding_model_version, 
            settings.EMBEDDING_MODEL_DIMENSIONS
        )
        
        logger.info(f"初始化本地EmbeddingService，使用模型: {self.embedding_model_version}，向量维度: {self.vector_dim}")
