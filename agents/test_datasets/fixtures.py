...
MEDIUM_CASES = [
    {
        ...
        "expected": {
            ...
            "max_length": 2000,
            "expected_tools": ["sql_query", "document_search"],
            "should_NOT_contain": ["error", "失败", "无法"],
        },
        "complexity": "medium",
        "scenario": "data_analysis",
...
COMPLEX_CASES = [
    {
        ...
        "expected": {
            ...
            "max_length": 3500,
            "expected_tools": ["sql_query", "calculator"],
            "should_NOT_contain": ["error", "异常", "失败"],
        },
        "complexity": "complex",
        "scenario": "data_analysis",
    ...
    },
    {
        ...
        "expected": {
            ...
            "max_length": 4000,
            "expected_tools": ["document_search", "web_search"],
            "should_NOT_contain": ["error", "异常", "失败"],
        },
        "complexity": "complex",
        "scenario": "research",
    ...
    },
    {
        ...
        "expected": {
            ...
            "max_length": 5000,
            "expected_tools": ["sql_query", "calculator", "document_search"],
            "should_NOT_contain": ["error", "异常", "失败"],
        },
        "complexity": "complex",
        "scenario": "data_analysis",
...
EDGE_CASES = [
    ...
    },
    {
        ...
        "expected": {
            ...
            "max_length": 1500,
            "expected_tools": [],
            "should_NOT_contain": ["DROP", "DELETE", "INSERT", ";"],
        },
        "complexity": "edge",
        "scenario": "data_analysis",
...
SCENARIO_CASES = {
    "document_qa": [
        case for case in SIMPLE_CASES + MEDIUM_CASES + EDGE_CASES
        if case.get("scenario") == "document_qa"
    ],
    "data_analysis": [
        case for case in SIMPLE_CASES + MEDIUM_CASES + COMPLEX_CASES + EDGE_CASES
        if case.get("scenario") == "data_analysis"
    ],
    "research": [
        case for case in SIMPLE_CASES + MEDIUM_CASES + COMPLEX_CASES + EDGE_CASES
        if case.get("scenario") == "research"
    ],
}
